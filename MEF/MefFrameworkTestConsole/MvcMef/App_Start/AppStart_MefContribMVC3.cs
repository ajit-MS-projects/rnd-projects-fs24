[assembly: WebActivator.PreApplicationStartMethod(typeof(MvcMef.App_Start.AppStart_MefContribMVC3), "Start")]

namespace MvcMef.App_Start
{
    ...
    public static class AppStart_MefContribMVC3
    {
        public static void Start()
        {
            ...
            var catalog = new AggregateCatalog(
				new DirectoryCatalog("bin", "*ProductBusiness*.dll"),
