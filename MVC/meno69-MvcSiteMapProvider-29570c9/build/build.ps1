...
task NuGet -depends Compile35,Compile -description "This tasks makes creates the NuGet packages" {  
    ...
    Copy-Item $base_directory\release\MvcSiteMapProvider\* $nuget_directory\lib -Recurse
